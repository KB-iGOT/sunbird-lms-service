...
public final class JsonKey {
    ...
    public static final String ES_USER_SERVICE = "User Elastic search service";
    ...
    public static final String USER_ES_IP = "user_es_host";
    ...
    public static final String SUNBIRD_EMAIL_MAX_RECEPIENT_LIMIT = "sunbird_email_max_recipients_limit";
    ...
    public static final String SUNBIRD_API_REQUEST_LOWER_CASE_FIELDS = "sunbird_api_request_lower_case_fields";
    ...
    public static final String SUNBIRD_KEYCLOAK_USER_FEDERATION_PROVIDER_ID = "sunbird_keycloak_user_federation_provider_id";
    ...
    public static final List<String> USER_UNAUTH_STATES = Arrays.asList(JsonKey.UNAUTHORIZED, JsonKey.ANONYMOUS);
    ...
    public static final String CONTACT_DETAILS_UPDATE_VERIFICATION_SUBJECT = "OTP to edit Diksha Profile";
    ...
    public static final String USER_CREATION_OPERATIONS = "user_creation_operations";
