...
public class OrganisationManagementActor extends BaseActor {
  ...
  private void updateOrgData(Request actorMessage) {
    ...
    try {
      ...
      String orgHierarchyId = (String) MapUtils.getObject(updateOrgDao, JsonKey.ORG_HIERARCHY_ID);
      String orgHierarchyStatus = (String) MapUtils.getObject(updateOrgDao, JsonKey.ORG_HIERARCHY_STATUS);
      ...
      if (StringUtils.isNotEmpty(orgHierarchyId)) {
        updateOrgDao.put(JsonKey.ORG_HIERARCHY_ID, orgHierarchyId);
      }
      if (StringUtils.isNotEmpty(orgHierarchyStatus)) {
        updateOrgDao.put(JsonKey.ORG_HIERARCHY_STATUS, orgHierarchyStatus);
      }
